                ...
                <table class="table table-hover table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'full_name'" :title="'Paper'" />
                            <table-th :sort="true" :tkey="'email'" :title="'Type'" />
                            <table-th :sort="true" :tkey="'subject'" :title="'Cost Per Page'" />
                            <table-th :sort="true" :tkey="'subject'" :title="'Cost Per Ream'" />
                            <table-th :sort="true" :tkey="'message'" :title="'Stock'" />
                            <table-th :sort="true" :tkey="'message'" :title="'Current Stock'" />
                            <table-th :sort="true" :tkey="'message'" :title="'Total'" />
